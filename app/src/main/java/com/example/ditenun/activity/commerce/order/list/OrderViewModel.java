...
public class OrderViewModel extends AndroidViewModel {
    ...
    public void fetchOrders(Integer page) {
        ...
        Call<List<Order>> call = networkInterface.getListOrders(WooCommerceApiClient.CONSUMER_KEY, WooCommerceApiClient.CONSUMER_SECRET, UserConfiguration.getInstance().getCustomerId(), page, 50);
